    ...
    <div class="contents content_container">
            ...
            ?>
                <div class="content d-flex justify-content-center">
                    <div class="thumb">
                      <a href="/teamPJ/teapot/user/event/event_detail.php?idx=<?php echo $r->ev_idx; ?>">
                        <img src="/teamPJ/teapot/admin/uploads/event/<?php echo $r->ev_thumb;?>">
                      </a>
                    </div>
                    <div class="desc">
                        <h3 class="suit_bold_m go"><a href="/teamPJ/teapot/user/event/event_detail.php?idx=<?php echo $r->ev_idx; ?>">[EVENT] <?php echo $r->ev_title; ?></a></h3>
                        <p>
                          기간: 
                            <?php 
                        ...
                        <p class="go"><a href="/teamPJteapot/user/event/event_detail.php?idx=<?php echo $r->ev_idx; ?>">자세히보기 <span>→<span></a></p>
                    </div>
                </div>
