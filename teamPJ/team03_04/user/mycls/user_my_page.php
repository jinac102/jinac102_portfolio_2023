...
<?php
  include $_SERVER["DOCUMENT_ROOT"]."/teamPJ/teapot/user/mycls/my_page_all.php";
    ...
    <main class="d-flex align-items-start justify-content-center">
      ...
      <div class="grid">
        ...
        <?php }else{?>
            ...
            <div class="card">
              <div class="img_wrap">
                <a href="/teamPJ/teapot/user/lec/classroom.php?clidx=<?php echo $s->clidx?>"><img src="<?php echo $s->thumb_url?>" class="card-img-top" alt="..." /></a>
              </div>
              <div
          ...
          <?php
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="btns">
                  <button class="btn-primary" onclick="window.open('/teamPJ/teapot/user/lec/classroom.php?clidx=<?php echo $r->clidx?>')">바로가기</button>
                </div>
