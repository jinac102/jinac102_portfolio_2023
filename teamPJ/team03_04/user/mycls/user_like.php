    ...
    <main class="d-flex align-items-start justify-content-center">
      <aside style="padding-top:200px;">
        <ul class="side_menu font_m">
          ...
          <li>
            <a href="http://jinac102.dothome.co.kr/teamPJ/teapot/user/mycls/user_like.php"
          ...
          <?php
            ...
            <div class="card mt-4">
              ...
              <div class="card-body">
                ...
                <div class="btns">
                  <button class="btn-primary" onclick="window.open('/teamPJ/teapot/user/lec/classroom.php?idx=<?php echo $r->clidx?>')">바로가기</button>
                </div>
