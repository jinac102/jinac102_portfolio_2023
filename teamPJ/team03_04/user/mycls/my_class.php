...
?>
    ...
    <aside style="padding-top:200px;">
        <ul class="side_menu font_m">
          ...
          <li>
            <a href="http://jinac102.dothome.co.kr/teamPJ/teapot/user/mycls/my_class.php"
          ...
          <table class="table">
            ...
            ?>
              <tr>
                ...
                <td><button class="anwser_btn" onclick="window.open('/teamPJ/teapot/user/lec/classroom.php?clidx=<?php echo $s->clidx?>')">바로가기</button></td>
              </tr>
              <?php }
              }?>
            </tbody>
