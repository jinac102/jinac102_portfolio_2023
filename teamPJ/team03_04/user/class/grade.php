            ...
            <div class="cls_R_BTN">
                ...
                >
                    <div class="form-check d-flex">
                        ...
                        ><a href="/teamPJ/teapot/user/class/grade.php?cls_FP=0">무료</a></div>
                        <div class="cls_p_RBTN RBTN suit_bold_s ">
                            <a href="/teamPJ/teapot/user/class/grade.php?cls_FP=1">유료</a>
                        </div>
...
$('.cls_ch_btn input').change(function(){
    ...
    if($FP == ""){
        current_url ="http://jinac102.dothome.co.kr/teamPJ/teapot/user/class/grade.php?";
    }else if($FP == 1){
        current_url = "http://jinac102.dothome.co.kr/teamPJ/teapot/user/class/grade.php?cls_FP=1&";
    }else if($FP == 0){
        current_url = "http://jinac102.dothome.co.kr/teamPJ/teapot/user/class/grade.php?cls_FP=0&";
    }
    let param = $(this).val();
...
<?php include $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/user/inc/user_footer_tail.php"; ?>