...
<?php
  include $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/user/inc/achivement.php";
  ?>
<footer class="lec_view lec_v_F d-flex justify-content-center align-items-center">
    ...
    <div class="prev_lec d-flex align-items-center">
        <?php 
            if($first_lec !== $lecidx){
                if($prev_lec){
                $prev_link = "/teamPJ/teapot/user/class/lec_main.php?clidx=$clidx&lidx=$prev_lec";
                }
    ...
    <div class="next_lec d-flex align-items-center">
        <?php
            ...
            if($last_lec !== $lecidx){
                if($next_lec)
                $next_link = "/teamPJ/teapot/user/class/lec_main.php?clidx=$clidx&lidx=$next_lec";
                if(isset($next_link)){
                    ?>
