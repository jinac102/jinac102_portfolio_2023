            ...
            <div class="cls_R_BTN">
                ...
                >
                    <div class="form-check d-flex">
                        ...
                        ><a href="/teamPJ/teapot/user/class/grade.php?cls_FP=0" class="">무료</a></div>
                        <div
                            class="cls_p_RBTN RBTN suit_bold_s <?= $cls_FP == 1; ?>"
                        ><a href="/teamPJ/teapot/user/class/grade.php?cls_FP=1" class="">유료</a></div>
                    </div>
                </div>
            </div>
            <div
...
$('.form-check-input').change(function(){
    ...
    let current_url = "http://jinac102.dothome.co.kr/teamPJ/teapot/user/class/class_list.php?";
    let param = $(this).val();
