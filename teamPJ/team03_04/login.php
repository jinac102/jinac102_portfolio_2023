        ...
        <div class="login_left d-flex justify-content-center">
          ...
          >
            ...
            <ul class="find_wrap m-3">
              <li>
                <a href="/teamPJ/teapot/user/member/findid.php" class="find_text mx-3">ID 찾기</a>
              </li>
              <li>
                <a href="/teamPJ/teapot/user/member/findpw.php" class="find_text mx-3"
                  >Password 찾기</a
                >
              </li>
              <li>
                <a href="/teamPJ/teapot/user/member/join.php" class="find_text mx-3">회원가입</a>
              </li>
            </ul>
...
<script src="<?php $_SERVER['DOCUMENT_ROOT']?>/teamPJ/teapot/user/js/login.js"></script>
