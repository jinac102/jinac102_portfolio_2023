...
<section class="notice_portfolio __hidden">
        ...
        <div class="border">
          ...
          <p>제작기간 : 22.02.13 ~ 23.03.15</p>
          <p>특징 : HTML, CSS, jQuery, javascript, php, MYSQL 활용</p>
          <p>
            구현 완료 페이지 : <a href="index.html" class="JA">클래스 리스트 페이지</a>,
            <a href="index.html" class="JA">강의 상세 페이지</a>,
            <a href="index.html" class="JA">QA 작성 페이지</a>
          </p>
        </div>
        <div class="flex">
          <div>
            <h3>&#8251;기획, 디자인</h3>
            <ul>
              <li class="JA">클래스 리스트 페이지</li>
              <li class="JA">클래스 상세 페이지(비로그인용) </li>
            </ul>
          </div>
          <div>
            <h3>&#8251;구현</h3>
            <ul>
              <li class="JA">클래스 리스트 페이지</li>
              <li class="JA">강의 상세 페이지</li>
              <li class="JA">QA 작성 페이지</li>
            </ul>
          </div>
        </div>
        <p>
