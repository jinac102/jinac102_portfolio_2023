<?php
    ...
    //     </script>";
    // };
  include $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/inc/db.php";
  include $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/inc/admin_header.php";
  include $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/inc/admin_aside.php";
...
<section class="notice_portfolio __hidden">
        ...
        <p>
          본 사이트에 사용된 모든 이미지의 저작권은<br />LG DISPLAY에 있으므로
          무단으로 사용할 수 없습니다.<br />
        ...
        <div class="border">
          ...
          <p>
            ...
            <a href="it.html">IT</a>, <a href="cmindex.html">Commercial</a>,
            <a href="OLED.html" class="JA">OLED</a>, <a href="esg.html">ESG</a>,
            <a href="media.html">미디어센터</a>,
            <a href="place.html" class="JA">사업장위치</a>
          </p>
        </div>
        <div class="flex">
          <div>
            ...
            <ul>
              <li>Main : 이&#42;욱</li>
              <li>IT : 박&#42;정, 이&#42;욱</li>
              <li>Commercial : 이&#42;경</li>
              <li><span class="JA"> OLED : 차진아</span>, 홍&#42;헌</li>
              <li>ESG : 이&#42;경</li>
              <li>
                <span class="JA">미디어센터</span> : 박&#42;정,
                <span class="JA">차진아</span>
              </li>
              <li><span class="JA">사업장위치 : 차진아</span></li>
            </ul>
          </div>
          <div>
            <h3>&#8251;구현</h3>
            <ul>
              <li>Header : 이&#42;욱, <span class="JA">차진아</span></li>
              <li>Footer, Top btn : 박&#42;정</li>
              <li>Common CSS : 홍&#42;헌</li>
              <li>Main : 이&#42;욱</li>
              <li>IT : 박&#42;정, 이&#42;욱</li>
              <li>Commercial : 이&#42;경</li>
              <li><span class="JA">OLED : 차진아</span>, 홍&#42;헌</li>
