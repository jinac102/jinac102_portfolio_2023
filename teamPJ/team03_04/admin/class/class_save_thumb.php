<?php
    ...
    $save_dir = $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/admin/uploads/class_thumb/"; 
    ...
    if(move_uploaded_file($_FILES['savefile']['tmp_name'], $save_dir.$savefile)){
        ...
        $return_data = array("result"=>"success", "imgurl" => '/teamPJ/teapot/admin/uploads/class_thumb/'.$savefile);
        echo json_encode($return_data);
        exit;
    } else{
