...
include $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/admin/inc/admin_header.php";
...
<?php
include $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/admin/inc/admin_aside.php";
?>
        <main class="p-5 col-md-10">
          ...
          <table class="table">
            ...
            ?>
              <tr>
                <td><img src="/teamPJ/teapot/admin/uploads/event/<?php echo $r->ev_thumb;?>"></td>
                ...
                <td class="event_btn">
                  <div>
                    ...
                    <button class="btn_s go" onclick="window.open('/teamPJ/teapot/user/event/event_detail.php?idx=<?php echo $r->ev_idx?>')">바로가기</button>
                  </div>
                </td>
              </tr>
              <?php
  ...
  include $_SERVER['DOCUMENT_ROOT']."/teamPJ/teapot/admin/inc/admin_footer.php";
